odoo.define('one_page_website_calendar.one_page_booking_options', function (require) {
    'use strict';
    ...
    options.registry.one_page_booking_options = options.Class.extend({
        ...
        _render: function () {
            this.$('#one_page_start_booking').replaceWith(QWeb.render('BookingType',
                {
